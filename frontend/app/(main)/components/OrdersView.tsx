...
export default function OrdersView({
  ...
  const tokenKey = "peekori_admin_token";
  const getAuthToken = () =>
  ...
  const fetchOrders = async () => {
    try {
      ...
      const transformed: Order[] = rawData.map((order) => ({
        ...
        landingPageSlug: order.landing_page_slug || "",
      }));
                ...
                {form && !detailLoading && !detailError && (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-3 rounded border border-gray-200 bg-gray-50 p-3 text-xs">
                        <div>
                          <div className="font-medium text-gray-500">Source</div>
                          <div className="text-gray-900">
                            {detailOrder?.attribution?.utm_source || "-"}
                          </div>
                        </div>
                        <div>
                          <div className="font-medium text-gray-500">Medium</div>
                          <div className="text-gray-900">
                            {detailOrder?.attribution?.utm_medium || "-"}
                          </div>
                        </div>
                        <div>
                          <div className="font-medium text-gray-500">Campaign</div>
                          <div className="text-gray-900 break-all">
                            {detailOrder?.attribution?.utm_campaign || "-"}
                          </div>
                        </div>
                        <div>
                          <div className="font-medium text-gray-500">Ref Code</div>
                          <div className="text-gray-900">
                            {detailOrder?.attribution?.ref_code || "-"}
                          </div>
                        </div>
                        <div className="col-span-2">
                          <div className="font-medium text-gray-500">Landing Page</div>
                          <div className="text-gray-900 break-all">
                            {detailOrder?.attribution?.landing_page_slug || "-"}
                          </div>
                        </div>
                      </div>
                    </div>
