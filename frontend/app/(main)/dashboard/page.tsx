...
export default function Home() {
  ...
  const buildOrdersUrl = (r: RangeKey) => {
    ...
    return `${baseUrl}/api/stats/orders?${params.toString()}`;
  };
  ...
  const buildRevenueUrl = (r: RangeKey) => {
    ...
    return `${baseUrl}/api/stats/revenue?${params.toString()}`;
  };
  ...
  return (
    <main className="min-h-screen p-6 sm:p-8 bg-slate-50">
      <h1 className="text-2xl sm:text-3xl font-semibold text-slate-800 mb-4">Welcome to Peekori Admin Dashboard</h1>
