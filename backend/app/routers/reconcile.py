...
async def _auto_reconcile_and_sign_once() -> None:
    ...
    API_BASE = os.getenv("BACKEND_INTERNAL_BASE", "https://admin.peekori.com").rstrip("/")
    ...
    async with httpx.AsyncClient(timeout=30.0) as client, \
        ...
        for payment_id in candidate_ids:
            try:
                ...
                vr = await client.post(f"https://test-backend.peekori.com/verify-razorpay", json=verify_payload)
